    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand active" href="${APP_PATH}/home">
                <img id="aust_img" alt="Brand" src="${APP_PATH}/aust.png" width="36" style="border-radius: 20px;">
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
            <ul class="nav navbar-nav" >
                ...
                <c:if test="${sessionScope.user.role == 'admin'}">
                    ...
                    <li><a href="${APP_PATH}/vip/vipList">会员管理</a></li>
                    <li><a href="${APP_PATH}/checkout/toCheckout">结算记录</a></li>
                    <li><a href="${APP_PATH}/checkout/toCheckoutSale">统计信息</a></li>
                </c:if>
            </ul>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    &nbsp;&nbsp;&nbsp;&nbsp;《基于Java的超市管理系统》，属于@<a style="text-decoration: none" href="#" target="_blank"></a>版权所有！
                </p>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
