...
<div class="container">
    ...
    <div style="width: 100%; margin: 0 auto; height: 100px;">
        ...
        --%>
        <form class="form-inline" action="${APP_PATH}/product/searchPro" method="post" style=" width: 100%; margin: 0 auto;height: 55px;border-radius: 5px;padding: 10px;background-color: #6486fa;color: #fff;">
