...
<script>
    ...
    /*设置&取消当前用户VIP*/
    function resetSelectedUserVip(id, username) {
        if (confirm("您确定更改【" + username + "】的VIP状态吗？")) {
            location.href = "${APP_PATH}/resetSelectedUserVip?id=" + id;
        }
    }
...
<div class="container">
    ...
    <div style="width: 100%; margin: 0 auto; height: 100px;">
        ...
        <ol class="breadcrumb">
            ...
            <form style=" width: 100%; margin: 0 auto;height: 55px;border-radius: 5px;padding: 10px;background-color: #6486fa;color: #fff;">
            ...
            <c:forEach items="${pageInfo.list}" var="user">
                <tr>
                    ...
                    <td>
                        ...
                        <a type="button" class="btn btn-danger btn-sm" aria-label="Left Align"
                           href="javascript:resetSelectedUserVip(`${user.id}`,`${user.username}`);">
                            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> 更改VIP状态
                        </a>
